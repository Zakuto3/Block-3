...
#include "C:\Users\Zak\Documents\Atom Projects\block3\Lab2\Lab2\Queue.c"
#include "C:\Users\Zak\Documents\Atom Projects\block3\Lab2\Lab2\Stack.c"
#include "C:\Users\Zak\Documents\Atom Projects\block3\Lab2\Lab2\Set.c"
...
void testFunctionSet()
{
    ...
    int occurances = 0;
    struct node *current;
    for(current = mySet->next; current != current; current = current->next)
